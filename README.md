...
* **Surface Temperature comparison:** A comparison of surface temperatures derived from AMSR2 Ka-band observations against thermal infrared data from the [Sentinel-3 SLSTR](https://sentinels.copernicus.eu/web/sentinel/missions/sentinel-3/instrumentation/slstr)
